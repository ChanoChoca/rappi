...
import com.chanochoca.app.exception.UserException;
...
public class Auth0Service {
    ...
    public void addLandlordRoleToUser(ReadUserDTO readUserDTO) {
        if (readUserDTO.authorities().stream().noneMatch(role -> role.equals(SecurityUtils.ROL_CLIENTE))) { // Cambiar ROLE_LANDLORD a ROL_ADMIN
            try {
